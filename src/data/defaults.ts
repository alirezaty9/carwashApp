...
export const DEFAULT_CONFIG: CarwashConfig = {
  ...
  /**
   * پیش‌فرض «چاپِ حرارتیِ مستقیم» است چون پرینترهای فیش‌زن درایورِ اختصاصی ندارند
   * و مسیرِ معمولِ چاپ رویشان کاغذِ بی‌پایانِ نامفهوم می‌دهد.
   */
  printMode: 'thermal',
  /**
   * پیش‌فرضِ «باریک» عمدی است: فیشِ باریک روی کاغذِ پهن فقط حاشیه‌ی خالی می‌گذارد،
   * ولی فیشِ پهن روی کاغذِ باریک از لبه بیرون می‌زند و مبلغ بریده می‌شود.
   */
  paperWidth: '58',
  printerName: '',
};
